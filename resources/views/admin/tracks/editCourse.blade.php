...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form role="form" method="POST" action={{ route('tracks.courses.update', [$track, $course]) }} enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Course</p>
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Update Course</button>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Tracks</label>
                                        <select name='track_id' class="form-select" aria-label="Default select example">
                            ...
                            <br/>
                                ...
                                <div class="col-md-12 mt-5">
                                    <div class="form-group form-check form-switch" >
                                        <input class="form-check-input" name="status" type="checkbox" id="flexSwitchCheckDefault" {{($course->status == 1)?'checked':''}}>
