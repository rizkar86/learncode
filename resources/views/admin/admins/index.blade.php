          ...
          {{--   <div class="alert alert-light" role="alert">
            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Admins</h6> 
                    <a class="btn btn-primary btn-sm float-end" href="{{ route('admins.create') }}" >Add Admin</a>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-end">
                                        <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                            <a class="text-sm font-weight-bold mb-0" href="{{ route('admins.edit', $user->id) }}">Edit</a>
