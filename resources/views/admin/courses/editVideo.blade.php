...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form role="form" method="POST" action={{ route('courses.videos.update', [$course,$video]) }} enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Video</p>
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Update Video</button>
                            </div>
                        </div>
                        <div class="card-body">
                            <p class="text-uppercase text-sm">Video Information</p>
                            <div class="row">
                                <div class="col-md-6">
