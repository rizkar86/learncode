...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form role="form" method="POST" action={{ route('quizzes.update', $quiz) }} enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Quiz</p>
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Update Quiz</button>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" value="{{$quiz->name}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
