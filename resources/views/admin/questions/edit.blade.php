...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form role="form" method="POST" action={{ route('questions.update',$question) }} enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Question</p>
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Edit Question</button>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Answers</label>
                                        <textarea class="form-control" type="text" name="answers" >{{$question->answers}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Right answer</label>
                                        <input class="form-control" type="text" name="right_answer"  value="{{$question->right_answer}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="score" value="{{$question->score}}" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
